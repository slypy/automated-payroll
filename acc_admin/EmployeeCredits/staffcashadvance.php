        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table id="staff-ca-table" class="table table-sm table-hover" cellspacing="0">
    ...
    <div class="col-md-12">
        <div class="card card-plain">
            ...
            <div id="display-paid-tbl-staffCA" class="card-body" style="display: none;">
                <div class="table-responsive">
                    <table id="paid-staff-ca-table" class="table table-sm table-hover" cellspacing="0">
                        <thead class="text-primary text-sm">
                            <th>
                                Employee ID #
                            </th>
    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table id="staff-loan-table" class="table table-sm table-hover" cellspacing="0">
                        <thead class="text-primary text-sm">
                            <th>
                                Employee ID #
                            </th>
    ...
    <div class="col-md-12">
        <div class="card card-plain">
            ...
            <div id="display-paid-staffLoan" class="card-body" style="display: none;">
                <div class="table-responsive">
                    <table id="paid-staff-loan-table" class="table table-sm table-hover" cellspacing="0">
                        <thead class="text-primary text-sm">
                            <th>
                                Employee ID #
                            </th>
    ...
    <div class="col-md-12">
        <div class="card card-plain">
            ...
            <div id="display-paid-employeeMisc" class="card-body" style="display: none;">
                <div class="table-responsive">
                    <table id="paid-employee-misc-table" class="table table-sm table-hover" cellspacing="0">
                        <thead class="text-primary text-sm">
                            <th>
                                Employee ID #
                            </th>
    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table id="staff-damages-table" class="table table-sm table-hover" cellspacing="0">
                        <thead class="text-primary text-sm">
                            <th>
                                Employee ID #
                            </th>
    ...
    <div class="col-md-12">
        <div class="card card-plain">
            ...
            <div id="display-paid-staffDamages" class="card-body" style="display: none;">
                <div class="table-responsive">
                    <table id="paid-staff-damages-table" class="table table-sm table-hover" cellspacing="0">
                        <thead class="text-primary text-sm">
                            <th>
                                Employee ID #
                            </th>

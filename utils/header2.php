...
<link rel="stylesheet" href="../frameworks/css/mydesign.css?v=<?php echo time(); ?>">
...
<!-- My js -->
<script type="text/javascript" defer src="../frameworks/js/mydesign.js?v=<?php echo time(); ?>"></script>
